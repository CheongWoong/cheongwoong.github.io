...
<div class="caption_left">
    \textbf{Correlational analysis of larger models:} We test GPT-3.5 175B and ChatGPT on the subset of test data in the *remove stopwords* setting, verifying that correlation remains despite scaling up model sizes.
</div>
